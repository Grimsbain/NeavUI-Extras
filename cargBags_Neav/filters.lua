...
function cbNeav:UpdateBags() for i = -3, 11 do cbNeav:UpdateBag(i) end end
...
cB_existsBankBag = { Armor = true, Gem = true, Quest = true, TradeGoods = true, Consumables = true, ArtifactPower = true, BattlePet = true, Fishing = true }
cB_filterEnabled = { Armor = true, Gem = true, Quest = true, TradeGoods = true, Consumables = true, Keyring = true, Junk = true, Stuff = true, ItemSets = true, ArtifactPower = true, BattlePet = true, Fishing = true }
...
cB_Filters.fBankFilter = function() return cBneavCfg.FilterBank end
cB_Filters.fHideEmpty = function(item) if cBneavCfg.CompressEmpty then return item.link ~= nil else return true end end
...
local function CanGoInBag(itemID,bagType)
    ...
    if itemFamily == 67108872 then return false end
